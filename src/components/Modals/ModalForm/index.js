...
import { priorityList } from "../../../constants/todoPriority";
import { IconArrowDown } from "../../Icons";
import { Checked } from "../../../static/icons";
    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <MenuList>
                      {priorityList.map((priority, i) => (
                        ...
                        >
                          ...
                          {priority.id === value && <Image src={Checked} />}
                        </MenuItem>
                      ))}
                    </MenuList>
                  </Menu>
          ...
          <ModalFooter borderTop={`1px solid #E5E5E5`} p={`15px 24px 19px`}>
            <Button
              ...
              py="13.5px"
              disabled={
                type === "add" && (!dirtyFields.title || !dirtyFields.priority)
              }
              type="submit"
            >
              Simpan
