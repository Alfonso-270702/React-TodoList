...
import { sortList as initialSortList } from "../../constants/sortList";
import {
  BackButton,
  Checked,
  EditTitle,
...
import { TodoEmpty } from "../../static/images";
...
export default function Detail() {
  ...
  return (
    <>
                ...
                >
                  <Box display="flex" alignItems="center">
                    <Image
                      ...
                      height="18px"
                    />
                    <Text data-cy="sort-selection-title">{sort.title}</Text>
                  </Box>
                  {sort.isChecked && <Image src={Checked} />}
                </MenuItem>
              ))}
            </MenuList>
          </Menu>
      ...
      >
        <ModalOverlay />
        <ModalContent data-cy="modal-information" minH={"58px"} minW="490px">
